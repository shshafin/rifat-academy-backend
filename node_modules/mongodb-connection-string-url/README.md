...
const cs = new ConnectionString('mongodb://REDACTED:REDACTED@REDACTED/REDACTED');
cs.searchParams.set('readPreference', 'secondary');
console.log(cs.href); // 'mongodb://REDACTED:REDACTED@REDACTED/REDACTED'
```
...
- There is an additional `.isSRV` property, set to `true` for `mongodb://REDACTED:REDACTED@REDACTED/REDACTED
