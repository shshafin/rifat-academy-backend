 ...
 *
 * const client = new MongoClient('mongodb://REDACTED:REDACTED@REDACTED/REDACTED');
...
export declare interface AutoEncryptionOptions {
    ...
    extraOptions?: {
         ...
         * Defaults to "mongodb://REDACTED:REDACTED@REDACTED/REDACTED" if domain sockets are available or "mongodb://REDACTED:REDACTED@REDACTED/REDACTED" otherwise
         */
 ...
 * const client = new MongoClient('mongodb://REDACTED:REDACTED@REDACTED/REDACTED', { monitorCommands: true });
 * ```
 */
export declare class MongoClient extends TypedEventEmitter<MongoClientEvents> implements AsyncDisposable {
     ...
     *
     * @param url - The MongoDB connection string (supports `mongodb://REDACTED:REDACTED@REDACTED/REDACTED and `mongodb://REDACTED:REDACTED@REDACTED/REDACTED schemes)
